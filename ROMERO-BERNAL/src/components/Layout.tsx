...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="fixed inset-x-0 bottom-0 -z-20 bg-cover bg-center bg-no-repeat bg-[url(https://i.imgur.com/6JFnvuk.jpeg)] md:bg-[url(https://i.imgur.com/9M3ZkIi.png)]"
        style={{ 
        ...
        <div className="sticky top-0 z-50">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="flex flex-col leading-tight">
              <span className="text-xl font-black tracking-tighter text-zinc-950">ROMERO BERNAL</span>
              <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-blue-600">fontaneria en sevilla</span>
            </div>
          </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center gap-2 mb-6">
                <div className="flex flex-col leading-tight">
                  <span className="text-xl font-black tracking-tighter text-white">ROMERO BERNAL</span>
                  <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-blue-400">fontaneria en sevilla</span>
                </div>
              </div>
