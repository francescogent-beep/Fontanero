              ...
              <div className="sticky top-32 space-y-6">
                <Card className="bg-zinc-900 text-white border-none p-8">
                  ...
                  <p className="text-zinc-400 text-sm mb-8">
                    Llámanos o escríbenos por WhatsApp para obtener un presupuesto sin compromiso para {service.title.toLowerCase()}.
                  </p>
                  <div className="space-y-4">
                    <Button href={`tel:${BUSINESS_DETAILS.contact.phone}`} variant="primary" className="w-full">
                      Llamar Ahora
                    </Button>
                ...
                <Card className="bg-blue-50 border-blue-100 p-8">
                  ...
                  <ul className="space-y-3 text-sm text-blue-800">
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-blue-600" /> Profesionales en {BUSINESS_DETAILS.address.city}
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-blue-600" /> Garantía por escrito
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-blue-600" /> Precios competitivos
                    </li>
                  </ul>
                </Card>
              </div>
